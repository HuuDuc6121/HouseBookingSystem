...
public class LoginGoogleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code == null || code.isEmpty()) {
            ...
            Model.UerGoogle user = getUserInfo(accessToken);
    ...
    public static Model.UerGoogle getUserInfo(final String accessToken) throws ClientProtocolException, IOException {
        String link = Model.Constants.GOOGLE_LINK_GET_USER_INFO + accessToken;
        String response = Request.Get(link).execute().returnContent().asString();

        Model.UerGoogle googlePojo = new Gson().fromJson(response, Model.UerGoogle.class);
